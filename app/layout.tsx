...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      "نرم افزار و اپلیکیشن مدیریت مدارس و آموزشگاه ها دفتر کلاسی آزمون آنلاین | نرم افزار مدرسه",
    url: "https://farsamooz.ir/",
    siteName: "Next.js",
    images: [
      {
      ...
      },
      {
        ...
        width: 1800,
        height: 1600,
        alt: " نرم افزار و اپلیکیشن هوشمند مدیریت مدارس | نرم افزار مدرسه",
      },
    ],
    locale: "fa_IR",
    type: "website",
  },
  title: " 46250471   پارس آموز  نرم افزار و اپلیکیشن هوشمند مدیریت مدرسه",
